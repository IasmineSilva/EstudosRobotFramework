...
Esse aqui também vai passar com uma condição e vai parar de executar as keywords abaixo!
    ${STATUS}   Run Keyword And Return Status   Should Be True    "Iasmine" == "Iasmine"
    Log  ${STATUS}
    Pass Execution If    ${STATUS}    message=Iasmine é igual a May, então passou!!

Esse keyword vai passar sozinha!
    Should Be True    "Iasmine" == "Iasmine"

Esse keyword vai falhar sozinha!
    Should Be True    "Iasmine" == "Mateus"
